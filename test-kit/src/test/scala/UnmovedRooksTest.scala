  ...
  test("rook capture rook"):
    fenToGame(
      ...
      .assertRight: g =>
        ...
        assertEquals(g.situation.castles, Castles(true, false, true, false))
  ...
  test("capture at the corner"):
    fenToGame(
      ...
      .assertRight: g =>
        ...
        assertEquals(g.situation.castles, Castles(false, true, false, true))
  ...
  test("capture an unmovedRook"):
    fenToGame(
      ...
      .assertRight: g =>
        ...
        assert(g.history.unmovedRooks.contains(G8))
        assertEquals(g.situation.castles, Castles(false, true, true, true))
  ...
  test("An unmovedRooks moves, black"):
    fenToGame(FullFen("qrnbkrbn/ppppp1pp/8/5p2/4PP2/8/PPPP2PP/QRNBKRBN b KQkq - 0 2"), Chess960)
      ...
      .assertRight: g =>
        ...
        assertEquals(g.situation.castles, Castles(true, true, false, true))
  ...
  test("the king moves, white"):
    fenToGame(FullFen("rkrnnqbb/p1pppppp/1p6/8/8/1P6/P1PPPPPP/RKRNNQBB w KQkq - 0 2"), Chess960)
      ...
      .assertRight: g =>
        ...
        assertEquals(g.situation.castles, Castles(false, false, true, true))
  test("the king moves, black"):
    fenToGame(
      ...
      .assertRight: g =>
        ...
        assertEquals(g.situation.castles, Castles(true, true, false, false))
