...
R   K""", Black)
  ...
  "update half move clock" should {
    ...
    "increment" in {
      Game(variant.Standard)(G1, F3) must beValid.like {
        case (game, _) => game.halfMoveClock must_== 1
      }
    }
    "not increment" in {
      Game(variant.Standard)(E2, E4) must beValid.like {
