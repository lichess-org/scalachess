...
class FenTest extends ChessTest:
  ...
  "dump" should {
    "enpassant" in {
      ...
      Fen.write(sit.state) === Fen("rnbqkbnr/pp1p1ppp/8/2pPp3/8/8/PPP1PPPP/RNBQKBNR w KQkq c6 0 3")
    }
    "enpassant in game" in {
      ...
      Fen.write(sit.state) === Fen("5rk1/ppp3pp/2np4/2q5/3Pp1n1/NPP5/PB2Q1PP/R5KR b - d3 0 17")
    }
    "not enpassant in game" in {
      ...
      val sit = Reader.full(pgn).flatMap(_.valid).toOption.get
      Fen.write(sit.state) === Fen("3r1r2/1p5k/pb1q2p1/3p2Pp/4pP2/2B1P1P1/PP1Q2K1/R6R w - - 0 28")
    }
  }
