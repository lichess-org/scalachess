...
class BinaryTest extends ChessTest {
  ...
  "binary encoding" should {
    ...
    "write single move" in {
      ...
      "simple piece" in {
        writeMove("Ka1") must_== "01000000,00000001,00000000"
        writeMove("Qa2") must_== "01000001,00000010,00000000"
        writeMove("Rh4") must_== "01111011,00000011,00000000"
        writeMove("Dh4") must_== "01111011,00001000,00000000"
      }
      "simple piece with capture" in {
        writeMove("Kxa1") must_== "01000000,00000001,00000100"
        writeMove("Qxa2") must_== "01000001,00000010,00000100"
        writeMove("Rxh4") must_== "01111011,00000011,00000100"
        writeMove("Dxh4") must_== "01111011,00001000,00000100"
      }
      "simple piece with check" in {
        writeMove("Ka1+") must_== "01000000,00000001,00001000"
        writeMove("Qa2#") must_== "01000001,00000010,00010000"
        writeMove("Rxh4+") must_== "01111011,00000011,00001100"
      }
      "pawn capture" in {
      ...
      "castling" in {
        writeMove("O-O") must_== "01000000,00000110,00000000"
        writeMove("O-O-O") must_== "01000000,00000111,00000000"
      }
      "castling with check" in {
        writeMove("O-O+") must_== "01000000,00000110,00001000"
        writeMove("O-O-O#") must_== "01000000,00000111,00010000"
      }
      "drop" in {
        writeMove("N@a1") must_== "01000000,00000100,00000010"
      }
      "drop with check" in {
        writeMove("N@a1+") must_== "01000000,00000100,00001010"
      }
      "drop with checkmate" in {
        writeMove("N@a1#") must_== "01000000,00000100,00010010"
      }
      "disambiguated by file" in {
        writeMove("Kfa1") must_== "11000000,00000001,00000000,00000101"
      }
      "disambiguated by file on h8" in {
        writeMove("Kfh8") must_== "11111111,00000001,00000000,00000101"
      }
      "disambiguated by rank" in {
        writeMove("K8a1") must_== "11000000,00000001,00000000,01000111"
      }
      "disambiguated fully" in {
        writeMove("Kf4a1") must_== "11000000,00000001,00000000,10101011"
      }
      "disambiguated fully with capture" in {
        writeMove("Kf4xa1") must_== "11000000,00000001,00000100,10101011"
      }
      "disambiguated fully with check" in {
        writeMove("Kf4a1+") must_== "11000000,00000001,00001000,10101011"
        writeMove("Kf4a1#") must_== "11000000,00000001,00010000,10101011"
      }
      "disambiguated fully with capture and check" in {
        writeMove("Kf4xa1+") must_== "11000000,00000001,00001100,10101011"
        writeMove("Kf4xa1#") must_== "11000000,00000001,00010100,10101011"
      }
      "disambiguated by rank with capture and check" in {
        writeMove("K8xa1+") must_== "11000000,00000001,00001100,01000111"
      }
    }
    "write many moves" in {
      "all games" in {
    ...
    "read single move" in {
      ...
      "simple piece" in {
        readMove("01000000,00000001,00000000") must_== "Ka1"
        readMove("01000001,00000010,00000000") must_== "Qa2"
        readMove("01111011,00000011,00000000") must_== "Rh4"
        readMove("01111011,00001000,00000000") must_== "Dh4"
      }
      "simple piece with capture" in {
        readMove("01000000,00000001,00000100") must_== "Kxa1"
        readMove("01000001,00000010,00000100") must_== "Qxa2"
        readMove("01111011,00000011,00000100") must_== "Rxh4"
        readMove("01111011,00001000,00000100") must_== "Dxh4"
      }
      "simple piece with check" in {
        readMove("01000000,00000001,00001000") must_== "Ka1+"
        readMove("01000001,00000010,00010000") must_== "Qa2#"
        readMove("01111011,00000011,00001100") must_== "Rxh4+"
      }
      "pawn capture" in {
      ...
      "castling" in {
        readMove("01000000,00000110,00000000") must_== "O-O"
        readMove("01000000,00000111,00000000") must_== "O-O-O"
      }
      "castling with check" in {
        readMove("01000000,00000110,00001000") must_== "O-O+"
        readMove("01000000,00000111,00010000") must_== "O-O-O#"
      }
      "drop" in {
        readMove("01000000,00000100,00000010") must_== "N@a1"
      }
      "drop with check" in {
        readMove("01000000,00000100,00001010") must_== "N@a1+"
      }
      "drop with checkmate" in {
        readMove("01000000,00000100,00010010") must_== "N@a1#"
      }
      "disambiguated by file" in {
        readMove("11000000,00000001,00000000,00000101") must_== "Kfa1"
      }
      "disambiguated by rank" in {
        readMove("11000000,00000001,00000000,01000111") must_== "K8a1"
      }
      "disambiguated fully" in {
        readMove("11000000,00000001,00000000,10101011") must_== "Kf4a1"
      }
      "disambiguated fully with capture" in {
        readMove("11000000,00000001,00000100,10101011") must_== "Kf4xa1"
      }
      "disambiguated fully with check" in {
        readMove("11000000,00000001,00001000,10101011") must_== "Kf4a1+"
        readMove("11000000,00000001,00010000,10101011") must_== "Kf4a1#"
      }
      "disambiguated fully with capture and check" in {
        readMove("11000000,00000001,00001100,10101011") must_== "Kf4xa1+"
        readMove("11000000,00000001,00010100,10101011") must_== "Kf4xa1#"
      }
      "disambiguated by rank with capture and check" in {
        readMove("11000000,00000001,00001100,01000111") must_== "K8xa1+"
      }
    }
    "be isomorphic" in {
      "for one" in {
