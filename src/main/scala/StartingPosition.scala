...
object StartingPosition {
  ...
  val categories: List[Category] = List(
    Category("e4", List(
      ...
      StartingPosition("C31", "King's Gambit: Falkbeer Countergambit", "rnbqkbnr/ppp2ppp/8/3pp3/4PP2/8/PPPP2PP/RNBQKBNR w KQkq d6 1 3", "King%27s_Gambit,_Falkbeer_Countergambit", "1. e4 e5 2. f4 d5"),
      ...
      StartingPosition("C41", "Philidor Defence: Lion Variation", "r1bqkb1r/pppn1ppp/3p1n2/4p3/3PP3/2N2N2/PPP2PPP/R1BQKB1R w KQkq - 0 5", "Philidor_Defence", "1. e4 d6 2. d4 Nf6 3. Nc3 e5 4. Nf3 Nbd7"),
      StartingPosition("B07", "Lion Variation: Anti-Philidor", "r1bqkb1r/pppn1ppp/3p1n2/4p3/3PPP2/2N5/PPP3PP/R1BQKBNR w KQkq - 0 5", "Philidor_Defence", "1. e4 d6 2. d4 Nf6 3. Nc3 Nbd7 4. f4 e5"),
      ...
      StartingPosition("B07", "Pirc Defence: Lion Variation", "r1bqkb1r/pppnpppp/3p1n2/8/3PP3/2N5/PPP2PPP/R1BQKBNR w KQkq - 3 4", "Pirc_Defence#Classical_.28Two_Knights.29_System", "1.e4 d6 2.d4 Nf6 3. Nc3 Nbd7"),
