...
class GlickoCalculatorTest extends ScalaCheckSuite with chess.MunitExtensions:
...

  {
    ...
    test("default deviation: white wins"):
      ...
      assert(w.deviation == b.deviation)
      assertCloseTo(w.deviation, 290.2305d, 0.00005d)
      assertCloseTo(b.deviation, 290.2305d, 0.00005d)
      // outcome was equally probable for both players
      assert(w.volatility == b.volatility)
    ...
    test("default deviation: draw"):
      ...
      assertCloseTo(b.deviation, 290.2305d, 0.00005d)
      assert(w.volatility == b.volatility)
      // draw is more expected than other outcomes
...

  {
    ...
    test("mixed ratings and deviations: white wins"):
      ...
      assertCloseTo(w.deviation, 77.4956d, 0.00005d)
      assertCloseTo(b.deviation, 105.8706d, 0.00005d)
...

  {
    ...
    test("more mixed ratings and deviations: white wins"):
      ...
      assertCloseTo(w.deviation, 59.9006d, 0.00005d)
      assertCloseTo(b.deviation, 196.9873d, 0.00005d)
