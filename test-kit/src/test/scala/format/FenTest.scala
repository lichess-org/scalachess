...
class FenTest extends ChessTest:
  ...
  test("write: enpassant"):
    ...
    assertEquals(
      Fen.write(sit.state),
      EpdFen("rnbqkbnr/pp1p1ppp/8/2pPp3/8/8/PPP1PPPP/RNBQKBNR w KQkq c6 0 3")
    )
  ...
  test("write: enpassant in game"):
    ...
    assertEquals(Fen.write(sit.state), EpdFen("5rk1/ppp3pp/2np4/2q5/3Pp1n1/NPP5/PB2Q1PP/R5KR b - d3 0 17"))
  ...
  test("write: not enpassant in game"):
    ...
    val sit = Reader.full(pgn).flatMap(_.valid).get
    assertEquals(Fen.write(sit.state), EpdFen("3r1r2/1p5k/pb1q2p1/3p2Pp/4pP2/2B1P1P1/PP1Q2K1/R6R w - - 0 28"))
  ...
  test("castling rights with 2 rooks on the same side"):
    val f1 = Fen.Epd("4k3/8/8/8/8/8/8/4K1RR w G -")
    val f2 = Fen.Epd("4k3/8/8/8/8/8/8/4K1RR w K -")
    val f3 = Fen.Epd("4k3/8/8/8/8/8/8/RR2K3 w B -")
    val f4 = Fen.Epd("4k3/8/8/8/8/8/8/RR2K3 w Q -")
    val f5 = Fen.Epd("rr2k3/8/8/8/8/8/8/4K3 w b -")
    val f6 = Fen.Epd("rr2k3/8/8/8/8/8/8/4K3 w q -")
    val f7 = Fen.Epd("4k1rr/8/8/8/8/8/8/4K3 w g -")
    val f8 = Fen.Epd("4k1rr/8/8/8/8/8/8/4K3 w k -")
