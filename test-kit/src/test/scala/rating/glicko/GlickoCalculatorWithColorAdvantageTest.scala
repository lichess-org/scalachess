...
class GlickoCalculatorWithColorAdvantageTest extends ScalaCheckSuite with chess.MunitExtensions:
...

  {
    ...
    test("default deviation: white wins"):
      ...
      assertCloseTo(w2.rating, 1658.56d, 0.005d)
      assertCloseTo(b2.rating, 1341.44d, 0.005d)
      assert(w2.deviation == b2.deviation)
      assertCloseTo(w2.deviation, 290.2538d, 0.00005d)
      assertCloseTo(b2.deviation, 290.2538d, 0.00005d)
      assert(w2.volatility == b2.volatility)
      assertCloseTo(w2.volatility, 0.0599992d, 0.0000001d)
      assertCloseTo(b2.volatility, 0.0599992d, 0.0000001d)
      // white win is more expected (crazyhouse first move)
      assertCloseTo(w3.rating, 1655.95d, 0.005d)
      assertCloseTo(b3.rating, 1344.05d, 0.005d)
      assert(w3.deviation == b3.deviation)
      assertCloseTo(w3.deviation, 290.2998d, 0.00005d)
      assertCloseTo(b3.deviation, 290.2998d, 0.00005d)
    ...
    test("default deviation: black wins"):
      ...
      assertCloseTo(w2.rating, 1334.08d, 0.005d)
      assertCloseTo(b2.rating, 1665.92d, 0.005d)
      assert(w2.deviation == b2.deviation)
      assertCloseTo(w2.deviation, 290.2538d, 0.00005d)
      assertCloseTo(b2.deviation, 290.2538d, 0.00005d)
      assert(w2.volatility == b2.volatility)
      ...
      assertCloseTo(w3.rating, 1331.37d, 0.005d)
      assertCloseTo(b3.rating, 1668.63d, 0.005d)
      assert(w3.deviation == b3.deviation)
      assertCloseTo(w3.deviation, 290.2998d, 0.00005d)
      assertCloseTo(b3.deviation, 290.2998d, 0.00005d)
      assert(w3.volatility == b3.volatility)
      assertCloseTo(w3.volatility, 0.0599994d, 0.0000001d)
      assertCloseTo(b3.volatility, 0.0599994d, 0.0000001d)
    test("default deviation: draw"):
      ...
      assertCloseTo(w1.rating, 1500.00d, 0.005d)
      assertCloseTo(b1.rating, 1500.00d, 0.005d)
      assert(w1.deviation == b1.deviation)
      assertCloseTo(w1.deviation, 290.2305d, 0.00005d)
      assertCloseTo(b1.deviation, 290.2305d, 0.00005d)
      assert(w1.volatility == b1.volatility)
      ...
      assertCloseTo(w2.rating, 1496.32d, 0.005d)
      assertCloseTo(b2.rating, 1503.68d, 0.005d)
      assert(w2.deviation == b2.deviation)
      assertCloseTo(w2.deviation, 290.2538d, 0.00005d)
      assertCloseTo(b2.deviation, 290.2538d, 0.00005d)
      assert(w2.volatility == b2.volatility)
      ...
      assertCloseTo(w3.rating, 1493.66d, 0.005d)
      assertCloseTo(b3.rating, 1506.34d, 0.005d)
      assert(w3.deviation == b3.deviation)
      assertCloseTo(w3.deviation, 290.2998d, 0.00005d)
      assertCloseTo(b3.deviation, 290.2998d, 0.00005d)
      assert(w3.volatility == b3.volatility)
...

  {
    ...
    test("mixed ratings and deviations: white wins"):
      ...
      assertCloseTo(w2.rating, 1422.16d, 0.005d)
      assertCloseTo(b2.rating, 1507.28d, 0.005d)
      assertCloseTo(w2.deviation, 77.4603d, 0.00005d)
      assertCloseTo(b2.deviation, 105.7716d, 0.00005d)
      assertCloseTo(w2.volatility, 0.06d, 0.00001d)
      assertCloseTo(b2.volatility, 0.065d, 0.00001d)
      assertCloseTo(w3.rating, 1421.81d, 0.005d)
      assertCloseTo(b3.rating, 1507.98d, 0.005d)
      assertCloseTo(w3.deviation, 77.4359d, 0.00005d)
      assertCloseTo(b3.deviation, 105.7032d, 0.00005d)
    ...
    test("mixed ratings and deviations: black wins"):
      ...
      assertCloseTo(w1.volatility, 0.06d, 0.00001d)
      assertCloseTo(b1.volatility, 0.065d, 0.00001d)
      assertCloseTo(w2.rating, 1389.55d, 0.005d)
      assertCloseTo(b2.rating, 1569.75d, 0.005d)
      assertCloseTo(w2.deviation, 77.4603d, 0.00005d)
      assertCloseTo(b2.deviation, 105.7716d, 0.00005d)
      assertCloseTo(w2.volatility, 0.06d, 0.00001d)
      assertCloseTo(b2.volatility, 0.065d, 0.00001d)
      assertCloseTo(w3.rating, 1389.22d, 0.005d)
      assertCloseTo(b3.rating, 1570.37d, 0.005d)
      assertCloseTo(w3.deviation, 77.4359d, 0.00005d)
      assertCloseTo(b3.deviation, 105.7032d, 0.00005d)
      assertCloseTo(w3.volatility, 0.06d, 0.00001d)
      assertCloseTo(b3.volatility, 0.065d, 0.00001d)
    test("mixed ratings and deviations: draw"):
      ...
      assertCloseTo(w1.volatility, 0.06d, 0.00001d)
      assertCloseTo(b1.volatility, 0.065d, 0.00001d)
      assertCloseTo(w2.rating, 1405.85d, 0.005d)
      assertCloseTo(b2.rating, 1538.51d, 0.005d)
      assertCloseTo(w2.deviation, 77.4603d, 0.00005d)
      assertCloseTo(b2.deviation, 105.7716d, 0.00005d)
      assertCloseTo(w2.volatility, 0.06d, 0.00001d)
      assertCloseTo(b2.volatility, 0.065d, 0.00001d)
      assertCloseTo(w3.rating, 1405.52d, 0.005d)
      assertCloseTo(b3.rating, 1539.17d, 0.005d)
      assertCloseTo(w3.deviation, 77.4359d, 0.00005d)
      assertCloseTo(b3.deviation, 105.7032d, 0.00005d)
      assertCloseTo(w3.volatility, 0.06d, 0.00001d)
      assertCloseTo(b3.volatility, 0.065d, 0.00001d)
...

  {
    ...
    test("more mixed ratings and deviations: white wins"):
      ...
      assertCloseTo(w2.rating, 1216.68d, 0.005d)
      assertCloseTo(b2.rating, 1636.77d, 0.005d)
      assertCloseTo(w2.deviation, 59.8952d, 0.00005d)
      assertCloseTo(b2.deviation, 196.7954d, 0.00005d)
      assertCloseTo(w2.volatility, 0.053013d, 0.000001d)
      assertCloseTo(b2.volatility, 0.062028d, 0.000001d)
      assertCloseTo(w3.rating, 1216.65d, 0.005d)
      assertCloseTo(b3.rating, 1637.36d, 0.005d)
      assertCloseTo(w3.deviation, 59.8912d, 0.00005d)
      assertCloseTo(b3.deviation, 196.6495d, 0.00005d)
    ...
    test("more mixed ratings and deviations: black wins"):
      ...
      assertCloseTo(w2.rating, 1199.25d, 0.005d)
      assertCloseTo(b2.rating, 1855.77d, 0.005d)
      assertCloseTo(w2.deviation, 59.8952d, 0.00005d)
      assertCloseTo(b2.deviation, 196.7954d, 0.00005d)
      assertCloseTo(w2.volatility, 0.052999d, 0.000001d)
      assertCloseTo(b2.volatility, 0.061999d, 0.000001d)
      assertCloseTo(w3.rating, 1199.22d, 0.005d)
      assertCloseTo(b3.rating, 1856.04d, 0.005d)
      assertCloseTo(w3.deviation, 59.8912d, 0.00005d)
      assertCloseTo(b3.deviation, 196.6495d, 0.00005d)
    ...
    test("more mixed ratings and deviations: draw"):
      ...
      assertCloseTo(w2.rating, 1207.97d, 0.005d)
      assertCloseTo(b2.rating, 1746.27d, 0.005d)
      assertCloseTo(w2.deviation, 59.8952d, 0.00005d)
      assertCloseTo(b2.deviation, 196.7954d, 0.00005d)
      assertCloseTo(w2.volatility, 0.053002d, 0.000001d)
      assertCloseTo(b2.volatility, 0.062006d, 0.000001d)
      assertCloseTo(w3.rating, 1207.94d, 0.005d)
      assertCloseTo(b3.rating, 1746.70d, 0.005d)
      assertCloseTo(w3.deviation, 59.8912d, 0.00005d)
      assertCloseTo(b3.deviation, 196.6495d, 0.00005d)
