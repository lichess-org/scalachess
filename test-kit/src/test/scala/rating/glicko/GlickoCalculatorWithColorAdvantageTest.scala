...
class GlickoCalculatorWithColorAdvantageTest extends ScalaCheckSuite with chess.MunitExtensions:
...

  {
    ...
    test("default deviation: white wins"):
      ...
      assertCloseTo(w1.deviation, 290.23d, 0.005d)
      assertCloseTo(b1.deviation, 290.23d, 0.005d)
...

  {
    ...
    test("mixed ratings and deviations: white wins"):
      ...
      assertCloseTo(w1.deviation, 77.50d, 0.005d)
      assertCloseTo(b1.deviation, 105.87d, 0.005d)
      assertCloseTo(w1.volatility, 0.06, 0.00001d)
      assertCloseTo(b1.volatility, 0.065, 0.00001d)
      assert(w1.rating > w2.rating)
      assert(b1.rating < b2.rating)
      assert(w2.rating > w3.rating)
      assert(b2.rating < b3.rating)
...

  {
    ...
    test("more mixed ratings and deviations: white wins"):
      ...
      assertCloseTo(w1.deviation, 59.90d, 0.005d)
      assertCloseTo(b1.deviation, 196.99d, 0.005d)
      assertCloseTo(w1.volatility, 0.053013, 0.000001d)
      assertCloseTo(b1.volatility, 0.062028, 0.000001d)
      assert(w1.rating > w2.rating)
      assert(b1.rating < b2.rating)
      assert(w2.rating > w3.rating)
      assert(b2.rating < b3.rating)
    test("more mixed ratings and deviations: black wins"):
      ...
      assertCloseTo(w1.deviation, 59.90d, 0.005d)
      assertCloseTo(b1.deviation, 196.99d, 0.005d)
      assertCloseTo(w1.volatility, 0.052999, 0.000001d)
      assertCloseTo(b1.volatility, 0.061999, 0.000001d)
      assert(w1.rating > w2.rating)
      assert(b1.rating < b2.rating)
      assert(w2.rating > w3.rating)
      assert(b2.rating < b3.rating)
    test("more mixed ratings and deviations: draw"):
      ...
      assertCloseTo(w1.deviation, 59.90056, 0.005d)
      assertCloseTo(b1.deviation, 196.98729, 0.005d)
      assertCloseTo(w1.volatility, 0.053002, 0.000001d)
      assertCloseTo(b1.volatility, 0.062006, 0.000001d)
      assert(w1.rating > w2.rating)
      assert(b1.rating < b2.rating)
      assert(w2.rating > w3.rating)
      assert(b2.rating < b3.rating)
