...
case class Situation(board: Board, color: Color):
  ...
  private def genEnPassant(ep: Pos): List[Move] =
    val pawns                                   = us & board.board.pawns & ep.pawnAttacks(!color)
